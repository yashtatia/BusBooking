...
public class FromVaranasi extends JFrame
{
    JComboBox CBFrom, CBTo, CBClass, CBAdult, CBChildren, CBInfant;
    JLabel LFrom, LTo, LBookingDate, LClass, LAdult, LChildren, LInfant, LBookingDetails, LPassengerDetails, LDate, LImg1;//LNotes;//LImg2
    ...
    public FromVaranasi(LoginPage type1)
    {
        Container c =getContentPane();
        c.setLayout(new BorderLayout());
        String[] sItem1={"Varanasi"};
        String[] sItem2 ={ "Mirzapur", "Junapur", "Delhi", "Rewa", "Allahabad", "Kanpur", "Lucknow", "Kannauj", "Etah" };
        ...
        BFindBus = new JButton("Check Availabilty");
        ...
        //LNotes = new JLabel("<html><body><p>Rad Map</p></body></html>");

        LPassengerDetails.setBounds(41,3,120,20);
        ...
        BFindBus.addActionListener(new button3(this, type1));
    }
    public static void main(String args[])
    {
        LoginPage type1=null;
        new FromVaranasi(type1);
    }
}
...
class button3 implements ActionListener
{
    FromVaranasi type;
    LoginPage type1;
    button3(FromVaranasi type, LoginPage type1)
    {
        this.type = type;
        this.type1 = type1;
    }
